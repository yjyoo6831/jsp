...
@WebServlet(value={"/student/list", "/student/list.json","/student/total","/student/insert","/student/read","/student/update"})
public class StudentServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/student/update":
			...
			request.setAttribute("pageName","/student/update.jsp");
			dis.forward(request, response);
			break;
		case "/student/read":
			request.setAttribute("stu", dao.read(request.getParameter("scode"))); //프론트에 값을 넘겨줄때
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		case "/student/insert":
			...
			break;
		case "/student/delete":
			String scode=request.getParameter("scode"); //프론트에서 값을 가져올떄
		...
		case "/student/update":
			...
			vo.setBirthday(request.getParameter("birthday"));
			dao.update(vo);
			response.sendRedirect("/student/read?scode=" +request.getParameter("scode"));
			break;
		}
	}
